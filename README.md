# Hi, I'm Mohamed Fadil 👋

**Graphic Designer turned Data Scientist-in-training** — I build things that look good *and* think.

2+ years freelancing in visual design (15+ client projects), now going deep on Data Science, Machine Learning, and GenAI. My focus: where design intuition meets data-driven products — brand systems that use AI, and analytics dashboards that don't look like they were built by an engineer who's never opened Figma.
...
**Design:** Adobe Photoshop · Illustrator · Figma · Framer · Squarespace
**Data / ML:** Python · Pandas · NumPy · scikit-learn · Matplotlib · Seaborn · Statsmodels
**Data & Infra:** SQL · SQLite · Snowflake concepts · AWS · GCP · Azure · Docker · Git
**Currently exploring:** LSTM/RNN, VAE, ensemble methods (Bagging/Boosting/Stacking), Streamlit app deployment

### 🎯 Right now

Preparing for a Pre-Placement Assessment covering Data Science, AI/GenAI, Full Stack, Cloud, IoT, and Embedded Systems — and building out a portfolio that shows design + ML work side by side, not as two separate people.
